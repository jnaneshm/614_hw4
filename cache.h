...
struct cache_mshr_t
{
  md_addr_t block_addr; /*addr of block*/
  unsigned int target_num; /*num of targets for a block */
  tick_t ready; /*time when block will be fetched */
};
/* cache definition */
struct cache_t
{
  ...
  tick_t ready; /*time when cache is ready when MSHR full */ 
  int num_mshr; /*number of MSHRs*/
  struct cache_mshr_t *mshr; 
  ...
  counter_t mshr_hits_under_misses;
